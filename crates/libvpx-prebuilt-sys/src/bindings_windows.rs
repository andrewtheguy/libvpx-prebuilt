...
// include/vpx/ — do not edit. Regenerate with bindgen 0.72.1 on a windows host.
//
...
pub type vp9e_temporal_layering_mode = ::std::os::raw::c_int;
...
pub type vp9e_tune_content = ::std::os::raw::c_int;
