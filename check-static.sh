...
#             finding `v1.16.0` in the file's bytes says yes, and says which. This is stronger
#             than the equivalent check in this repository's fdk-aac sibling, which has only
#             module titles to grep for.
